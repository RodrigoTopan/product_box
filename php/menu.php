<div>
<nav class="navbar navbar navbar-light bg-light" style="min-height: 100px;">
  <a class="navbar-brand" href="" style="width:90%;" align="center"><img src="../assets/img/logo.png" width="300px;"></a>
